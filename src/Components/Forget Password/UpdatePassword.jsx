        ...
        >
          ...
          <div className="row col-9 position-relative p-0">
            <input
              ...
              className=" text-center py-1 px-3 border border-dark rounded"
            ...
            />
                ...
                onClick={() => setShowpassword(!showPassword)}
                  className="bi bi-eye-slash text-dark fs-4 position-absolute"
                  style={{ width: "36px", right:"10px"}}
                ></i>
              ) : (
                <i
                  onClick={() => setShowpassword(!showPassword)}
                  className="bi bi-eye text-dark fs-4 position-absolute"
                  style={{ width: "36px", right:"10px"}}
                ></i>
              )}
          </div>
