      ...
      <section className="contatiner col-12 text-sm-start text-center d-flex flex-column align-items-start p-2">
        <div className="d-flex gap-2 align-items-center mb-3 justify-content-between w-100">
          <div className="d-flex align-items-center gap-3">
            <i
              className="d-block d-sm-none bi bi-list fs-5 pe-auto bg-danger px-2 rounded"
              onClick={handleclick}
            ></i>
        ...
        <div className="d-flex justify-content-between w-100 position-relative">
          ...
          <div className="d-sm-flex d-none gap-md-2 gap-1 position-absolute end-0 align-self-end">
            ...
            <button className="btn btn-outline-dark btn-sm">YEAR</button>
            <button className="btn btn-outline-dark btn-sm">SECTION</button>
          </div>
        </div>
